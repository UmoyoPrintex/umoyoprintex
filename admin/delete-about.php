...
if(isset($_GET['id']) && isset($_GET['image_name']))
{
    ...
    $sql="DELETE FROM tbl_about_history WHERE id=$id";
    //Execute the query
    ...
    {
        //service deleted
        $_SESSION['delete']="<div class='success'>About Us Deleted Successfully.</div>";
        header("location:".SITEURL.'admin/manage-about.php');
    }
    else
    {
        //failed to dlete
        $_SESSION['delete']="<div class='error'>Failed to Delete About Us...</div>";
        header("location:".SITEURL.'admin/manage-about.php');
    }
